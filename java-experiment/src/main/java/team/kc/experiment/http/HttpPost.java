package team.kc.experiment.http;
...
public class HttpPost {
	protected static final Logger logger = LoggerFactory.getLogger(HttpPost.class);
    ...
    public static void main (String[] args) {
    	try {
			System.out.println( send("http://10.133.12.130:8003/icr/recognize_vehicle_license?crop_image=1", new FileInputStream("d://1.png")) );
