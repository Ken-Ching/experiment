...
public class HelloWorldService {
  ...
  public interface Iface {
    ...
    public java.lang.String sayHello(team.kc.experiment.thrift.dto.HelloVo helloVo) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void sayHello(team.kc.experiment.thrift.dto.HelloVo helloVo, org.apache.thrift.async.AsyncMethodCallback<java.lang.String> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public java.lang.String sayHello(team.kc.experiment.thrift.dto.HelloVo helloVo) throws org.apache.thrift.TException
    {
      send_sayHello(helloVo);
      return recv_sayHello();
    }

    public void send_sayHello(team.kc.experiment.thrift.dto.HelloVo helloVo) throws org.apache.thrift.TException
    {
      sayHello_args args = new sayHello_args();
      args.setHelloVo(helloVo);
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void sayHello(team.kc.experiment.thrift.dto.HelloVo helloVo, org.apache.thrift.async.AsyncMethodCallback<java.lang.String> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      sayHello_call method_call = new sayHello_call(helloVo, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class sayHello_call extends org.apache.thrift.async.TAsyncMethodCall<java.lang.String> {
      private team.kc.experiment.thrift.dto.HelloVo helloVo;
      public sayHello_call(team.kc.experiment.thrift.dto.HelloVo helloVo, org.apache.thrift.async.AsyncMethodCallback<java.lang.String> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class sayHello<I extends Iface> extends org.apache.thrift.ProcessFunction<I, sayHello_args> {
      ...
      public sayHello_result getResult(I iface, sayHello_args args) throws org.apache.thrift.TException {
        sayHello_result result = new sayHello_result();
        result.success = iface.sayHello(args.helloVo);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class sayHello<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, sayHello_args, java.lang.String> {
      ...
      public void start(I iface, sayHello_args args, org.apache.thrift.async.AsyncMethodCallback<java.lang.String> resultHandler) throws org.apache.thrift.TException {
        iface.sayHello(args.helloVo,resultHandler);
      }
    }
  ...
  public static class sayHello_args implements org.apache.thrift.TBase<sayHello_args, sayHello_args._Fields>, java.io.Serializable, Cloneable, Comparable<sayHello_args>   {
    ...
    private static final org.apache.thrift.protocol.TField HELLO_VO_FIELD_DESC = new org.apache.thrift.protocol.TField("helloVo", org.apache.thrift.protocol.TType.STRUCT, (short)1);
    ...
    public team.kc.experiment.thrift.dto.HelloVo helloVo; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      HELLO_VO((short)1, "helloVo");
    ...
    static {
      ...
      tmpMap.put(_Fields.HELLO_VO, new org.apache.thrift.meta_data.FieldMetaData("helloVo", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, team.kc.experiment.thrift.dto.HelloVo.class)));
    ...
    public sayHello_args(
      team.kc.experiment.thrift.dto.HelloVo helloVo)
    {
      this();
      this.helloVo = helloVo;
    }
    ...
    public sayHello_args(sayHello_args other) {
      if (other.isSetHelloVo()) {
        this.helloVo = new team.kc.experiment.thrift.dto.HelloVo(other.helloVo);
      }
    }
    ...
    public team.kc.experiment.thrift.dto.HelloVo getHelloVo() {
      return this.helloVo;
    }

    public sayHello_args setHelloVo(team.kc.experiment.thrift.dto.HelloVo helloVo) {
      this.helloVo = helloVo;
      return this;
    }

    public void unsetHelloVo() {
      this.helloVo = null;
    }

    /** Returns true if field helloVo is set (has been assigned a value) and false otherwise */
    public boolean isSetHelloVo() {
      return this.helloVo != null;
    }

    public void setHelloVoIsSet(boolean value) {
      if (!value) {
        this.helloVo = null;
      }
    }
    ...
    public void setFieldValue(_Fields field, java.lang.Object value) {
      ...
      case HELLO_VO:
        if (value == null) {
          ...
          setHelloVo((team.kc.experiment.thrift.dto.HelloVo)value);
        }
        break;
    ...
    public boolean equals(sayHello_args that) {
      ...
      boolean this_present_helloVo = true && this.isSetHelloVo();
      boolean that_present_helloVo = true && that.isSetHelloVo();
      if (this_present_helloVo || that_present_helloVo) {
        if (!(this_present_helloVo && that_present_helloVo))
          return false;
        if (!this.helloVo.equals(that.helloVo))
          return false;
      }
    ...
    public int hashCode() {
      ...
      hashCode = hashCode * 8191 + ((isSetHelloVo()) ? 131071 : 524287);
      if (isSetHelloVo())
        hashCode = hashCode * 8191 + helloVo.hashCode();
    ...
    public int compareTo(sayHello_args other) {
      ...
      lastComparison = java.lang.Boolean.valueOf(isSetHelloVo()).compareTo(other.isSetHelloVo());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetHelloVo()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.helloVo, other.helloVo);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public java.lang.String toString() {
      ...
      sb.append("helloVo:");
      if (this.helloVo == null) {
        sb.append("null");
      } else {
        sb.append(this.helloVo);
      }
      first = false;
      sb.append(")");
      return sb.toString();
    ...
    private static class sayHello_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<sayHello_args> {
          ...
          switch (schemeField.id) {
            case 1: // HELLO_VO
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.helloVo = new team.kc.experiment.thrift.dto.HelloVo();
                struct.helloVo.read(iprot);
                struct.setHelloVoIsSet(true);
              } else { 
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, sayHello_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.helloVo != null) {
          oprot.writeFieldBegin(HELLO_VO_FIELD_DESC);
          struct.helloVo.write(oprot);
          oprot.writeFieldEnd();
        }
